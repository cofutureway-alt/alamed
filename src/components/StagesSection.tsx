  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 sm:h-52 w-full overflow-hidden bg-muted">
        ...
        {/* Soft bottom gradient overlay instead of harsh curve */}
      ...
      <div className="p-4 pt-1 flex flex-col flex-1 justify-between gap-3">
        ...
        <div className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl bg-secondary/60 group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-300 text-xs font-semibold">
