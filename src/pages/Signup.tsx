...
const Signup = () => {
  ...
  return (
    <AuthLayout
      ...
      subtitle={
        role === "student"
          ? "ابدأ رحلتك في تعلّم مادة البرمجة للبكالوريا"
...
const StudentForm = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      if (!signInErr) {
        setLoading(false);
        toast.success("تم تسجيل الدخول بنجاح، أهلاً بك في منصة العميد");
    ...
    toast.success("تم إنشاء حسابك بنجاح، أهلاً بك في منصة العميد");
    navigate(redirectTo, { replace: true });
  };
